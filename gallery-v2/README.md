...
```bash
pnpm --dir packages/n8n-node verify:gallery-scope
# Or gate one candidate before submission:
pnpm --dir packages/n8n-node verify:gallery-scope -- gallery-v2/02-cohort-to-certificates.json
```
...
- `02` is generated by `_build-02.mjs` and gated by `_test-02.mjs` through
  `pnpm --dir packages/n8n-node verify:gallery-02`; rebuilding is deterministic.
- `05` is generated by `_build-05.mjs` and gated by `_test-05.mjs` through
  `pnpm --dir packages/n8n-node verify:gallery-05`; rebuilding is deterministic.
